        ...
        <div className="background-wrapper">
          ...
          <div className="reviews float-up delay-4">
            ...
            <div className="review-item">
              ...
              <div className="review-content">
                <p>
                  "Where do I even begin? After years of bouncing from doctor to doctor, feeling unheard, dismissed, and exhausted, I finally found Dr. Kathy and everything changed. She was the only practitioner who truly got to the root of my symptoms and actually helped me heal. She provided in-depth testing and a personalized protocol, which was very eye opening to see what was going on inside my body after being told "everything looks normal" by other doctors, but she reassured me that I was in the right hands. Dr. Kathy helped me transform my health from the inside out. I no longer deal with menstrual cramps, bloating, fatigue, disordered eating, or weight loss issues that used to control my life. What stands out the most, is her heart. She thinks outside the box and brings so much compassion, patience, and deep care to every single call. You can feel her love and dedication with each interaction which is very rare in the medical field. Working with her has been the greatest investment I've ever made in myself. If you're on the fence, make the investment, it's worth it. &lt;3"
                </p>
              </div>
            </div>
